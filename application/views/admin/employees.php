      ...
      <div id="myDIV" style="display: block;">
             <form name="save_seller_form" id="save_seller_form" method="POST" enctype="multipart/form-data">
                <div class="col-sm-6 form-group">
                    ...
                    <input type="text" class="form-control" id="username" onblur="code_check(this.value)" name="username" placeholder="Employee Username" required="required">
                </div>
                <div class="col-sm-6 form-group">
                    <label for="name">Employee name:</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Employee Name" required="required">
                </div> 
                <div class="col-sm-6 form-group">
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Employee Mobile Number" required="required">
                </div>   
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th class="priority-3" style="width:30%;">Employee name</th> 
