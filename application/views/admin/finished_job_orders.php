                        ...
                        <?php if(count($finished)>0){
                            ...
                            foreach($finished as $finished){ ?>
                                <tr>
                                    ...
                                    <td class="priority-8" style="width:30%;vertical-align:middle;"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal_edit" onclick="edit('<?php echo $finished->id; ?>')">Pending Job Orders</button></td>  
                                </tr>
                           <?php } 
                        } 
                        else
